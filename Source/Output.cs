...
namespace Consolix
{
    public partial class Consolix
    {
        ...
        public static void Write(string text, ConsoleColor color, ConsoleColor background) =>
            WriteInColor(Console.Write, outputValue: text, color: color, background: background);
        ...
        public static void WriteLine(string text, ConsoleColor color, ConsoleColor background) =>
            WriteInColor(Console.WriteLine, outputValue: text, color: color, background: background);
        ...
        /// </summary>
        public static void Write(string formatString, object placeholderValue, ConsoleColor mainColor, ConsoleColor argumentColor) =>
        ...
        /// </summary>
        public static void WriteLine(string formatString, object placeholderValue, ConsoleColor mainColor, ConsoleColor argumentColor) =>
            WriteInColor(Console.WriteLine, formatString, placeholderValue, mainColor, argumentColor);

        /// <summary>
        /// Writes the specified text-format ("text {0}") with one argument in given colors without line break.
        /// </summary>
        public static void Write(string formatString, object placeholderValue, ConsoleColor mainColor, ConsoleColor argumentColor, ConsoleColor background) =>
            WriteInColor(Console.Write, formatString, placeholderValue, mainColor, argumentColor, background);

        /// <summary>
        /// Writes the specified text-format ("text {0}") in given colors with line break.
        /// </summary>
        public static void WriteLine(string formatString, object placeholderValue, ConsoleColor mainColor, ConsoleColor argumentColor, ConsoleColor background) =>
        ...
        /// </summary>
        public static void WriteLine(string format, ConsoleColor mainColor, ConsoleColor argumentColor, params object[] args) =>
        ...
        private static void WriteInColor<T>(Action<T> writeOrWriteline, T outputValue, ConsoleColor color, ConsoleColor background)
        {
